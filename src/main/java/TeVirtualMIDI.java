...
/* teVirtualMIDI Java interface - v1.2.11.41
 *
...
public class TeVirtualMIDI {
    ...
    static {
        try {
            ...
            System.load(Paths.get("tevirtualMIDI.dll").toAbsolutePath().toString());
        } catch( UnsatisfiedLinkError ignored ) {

            try {
                System.load(Paths.get("teVirtualMIDI32.dll").toAbsolutePath().toString());
            } catch( UnsatisfiedLinkError ignored2 ) {
                System.load(Paths.get("teVirtualMIDI64.dll").toAbsolutePath().toString());
            }
        }
